    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  <p align="center"><img src="images/Register.jpg" width="304" height="78" /></p>
		  
		  
		  
<form name="s" action="s_RegIns.jsp" method="post" enctype="multipart/form-data" onSubmit="return valid()"  ons target="_top">
            ...
            <label for="name"><span class="style22">Seller Name (required)<br />
            </span></label>
            </span><p class="style14"><input id="name" name="userid" class="text" />
            </p>
            ...
            <p class="style14"><input type="password" id="password" name="pass" class="text" /></p>
                  ...
                  <p align="right"><a href="s_login.jsp" class="style8">Back</a></p>
</form>		  
