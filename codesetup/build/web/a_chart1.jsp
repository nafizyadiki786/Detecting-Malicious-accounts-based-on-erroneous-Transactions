...
<head>
<title>View No.of Malacious Users and Normal Users</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> View No.of Malacious Users and Normal Users in Chart </h2>
		  <p>&nbsp;</p>
...
try
{
					...
					%><p align="center" class="style4">Total Registered Users : <%=count%></p>
<%
}
catch(Exception e)
{
