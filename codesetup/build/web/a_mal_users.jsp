...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> View Malicious Users Based on Product Purchase</h2>
		  <p>&nbsp;</p>
	...
	while ( rs.next() )
	   {
		...
		%>
                    ...
                    <tr>
                      ...
                      <td><div align="center" class="style9 style10 style12 style5 style6 style7"><a href="a_user_profile.jsp?user=<%=s2%>&type=<%="one"%>"><%=s2%></a></div></td>
