...
<head>
<title>View Friends Status</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> View Your Friends </span></h2>
		  <p>&nbsp;</p>
	...
	while ( rs.next() )
	   {
		...
		%>
                    ...
                    <tr>
					 ...
					 {
					 %><td><div align="center" class="style9 style10 style12 style5 style6 style7 style3"><a href="u_user_profile.jsp?user=<%=s3%>&type=<%="two"%>"><%=s3%></a></div></td><%
					 }
					 if(s3.equalsIgnoreCase(user))
					 {
					 %><td><div align="center" class="style9 style10 style12 style5 style6 style7 style3"><a href="u_user_profile.jsp?user=<%=s2%>&type=<%="two"%>"><%=s2%></a></div></td><%
					 }
