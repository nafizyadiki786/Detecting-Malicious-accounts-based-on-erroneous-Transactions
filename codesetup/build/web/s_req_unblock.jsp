...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> Seller Un-Block Request Status </h2>
		  <p>&nbsp;</p>
...
<%
    String name = request.getParameter("user");
			...
			%> <p align="center" class="style4">Requested Admin Successfully </p>
<%
...
%>
	      ...
	      <p align="right">              
		      ...
		      <p align="right">              
		      <p align="right">              
		      <p align="right"><a href="s_login.jsp" class="style3">Back</a>
                                      </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
