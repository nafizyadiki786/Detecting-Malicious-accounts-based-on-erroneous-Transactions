...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center">Welcome to User Main : <span class="style8"><%=application.getAttribute("user")%></span></h2>
		  <p>&nbsp;</p>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu style9">
            ...
            <li><a href="u_account.jsp">My Accounts </a></li>
            <li><a href="u_search_friend.jsp">Search Friends</a></li>
            <li><a href="u_friend_req.jsp">View Friend Requests </a></li>
            <li><a href="u_view_friends.jsp">View All My Friends </a></li>
            <li><a href="u_search_pro.jsp">Search Products</a></li>
            <li><a href="u_purchased_pro.jsp">View Purchased Products </a></li>
            <li><a href="u_transfer_amt.jsp">Transfer Amount to Your Friend </a></li>
