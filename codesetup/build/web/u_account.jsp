...
.style11 {font-family: "Times New Roman", Times, serif; font-size: 18px; }
-->
</style>
</head>
<body>
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> My Accounts </span></h2>
		  <p>&nbsp;</p>
...
<div class="article">
				...
				<li class="style11"><a href="u_create_acc.jsp">Create Bank Account</a> </li>
				<li class="style11"><a href="u_view_acc.jsp">View Account Details</a> </li>
				<li class="style11"><a href="u_ministatement.jsp">View Ministatement</a> </li>
				<li class="style11"><a href="u_add_money.jsp?type=<%="one"%>">Deposit Money</a> </li>
