...
<head>
<title>Send Friend Request Status</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center">  Friend Request Status </span></h2>
		  <p>&nbsp;</p>
...
try
{
					...
					if(rs.next())
					{
					  s4 = rs.getString(4);//satatus
						...
						{
						 %> 
            <span class="style10">You Have Already Sent him Friend Request. </span></p>
          <p><span class="style10">Please Wait...!!!</span> 
            <%
						}
						else if(s4.equalsIgnoreCase("Friends"))
						{
						 %> 
            <span class="style10">You Both Are Friends Already</span> 
            <%
						}				
					...
					else
					{
					 ...
					 %> 
            <span class="style13">Friend Request Sent Successfully</span> 
            <%
					}
