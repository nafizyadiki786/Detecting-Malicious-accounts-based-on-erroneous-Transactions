    ...
    try
	{
			...
			if(rs.next()==true)
			{
			   uamount=Integer.parseInt(rs.getString(8));
					...
					String query82="select * from user_acc_limit where pname='"+pname+"' and user='"+user+"' "; 
					Statement st82=connection.createStatement();
					ResultSet rs82=st82.executeQuery(query82);
					 if ( rs82.next()==true )//1
					 {
					  s6 =rs82.getString(4);//count
					  ...
					  if(k2<k1)
		              {
						...
						else
					    {
						  ...
						  connection.createStatement().executeUpdate(strQuery122);
						        ...
						        %> 
          <span class="style3">You Cannot Buy. Your Account Balance is Low.<br /></span><span class="style3">Please Add Money to Your Account, Otherwise You Will Be Blocked.</span> </p>
<p><span class="style13 style3">Insufficiant Amount !!! <br /> 
	                      Still need <%= (pprice-uamount)%> </span> 
	                      
                                        </p>
	                    <p><a href="u_add_money.jsp?type=<%="two"%>">ADD AMOUNT</a></p> 
			
			<p align="right"><a href="u_search_pro.jsp" class="style5">Back </a></p>
                        <%
...
%>
     <p align="center" class="style16 style17 style6 style8">Account Not Found.</p>
     <p align="center" class="style16 style17 style6 style8"> Please Create Your Account First.</p>
     <p align="right">&nbsp;</p>
     <p align="right"><a href="u_search_pro.jsp?pn=<%=pname%>" class="style5">Back </a></p>
     <br />
<%				                    		
